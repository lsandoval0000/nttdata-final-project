...
public class NewPersonalCreditRequestDto implements Serializable {
    ...
    @Digits(integer = 15, fraction = 2, message = "El monto de crédito debe tener como máximo dos decimales.")
    private BigDecimal creditAmount;
    @NotNull(message = "Se requiere la fecha en que se define el día del pago.")
    @Future(message = "La fecha de inicio de pago debe ser días posteriores al resgistro del crédito.")
    private Date initialDateToPay;
    @DecimalMin(value = "1", message = "El número de meses debe ser mayor a cero.")
    @Digits(integer = 15, fraction = 0, message = "El número de meses es un número entero positivo.")
    private Integer monthsToPay;
    @DecimalMin(value = "1.0", message = "La cuota mensual debe ser mayor a cero.")
    @Digits(integer = 15, fraction = 2, message = "La cuota mensual debe tener como máximo dos decimales.")
    private BigDecimal monthlyFee;
    @DecimalMin(value = "0.01", message = "Tasa de interés debe ser mayor a cero.")
    @Digits(integer = 15, fraction = 2, message = "Tasa de interés debe tener como máximo dos decimales.")
    private BigDecimal interestRate;
    @DecimalMin(value = "0.01", message = "Interés por mora debe ser mayor a cero.")
    @Digits(integer = 15, fraction = 2, message = "Interés por mora debe tener como máximo dos decimales.")
